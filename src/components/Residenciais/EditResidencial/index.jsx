...
import { viaCepApi } from "../../../service/api";
			...
			<form onSubmit={(e) => e.preventDefault()} style={styles.form}>
				<DialogContent style={styles.content}>
					...
					<InputBase
						...
						onChange={(e) =>
							handleChangeValue("logradouro", e.target.value)
						}
					...
					<InputBase
						...
						onChange={(e) =>
							handleChangeValue("complemento", e.target.value)
						}
					...
					<InputBase
						...
						value={form.bairro}
						onChange={(e) =>
							handleChangeValue("bairro", e.target.value)
						}
						placeholder='Bairro'
						style={styles.inputs}
					/>
					...
					<InputBase
						...
						onChange={(e) =>
							handleChangeValue("municipio", e.target.value)
						}
						placeholder='Cidade'
						style={styles.inputs}
					/>
					...
					<InputBase
						...
						value={form.uf}
						onChange={(e) =>
							handleChangeValue("uf", e.target.value)
						}
						placeholder='UF'
						style={styles.inputs}
						aria-label='UF'
